...
describe('CryptoService', () => {
  ...
  it('deve descriptografar um objeto corretamente', () => {
    const encryptedText = '';
    const decryptedText = service.decrypt(encryptedText, "5a203b97-53d6-406a-9909-89883e217abb");
